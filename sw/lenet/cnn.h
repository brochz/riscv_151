...
#define WT_CONV1_DDR_ADDR 0x000000
#define WT_CONV2_DDR_ADDR 0x0000c8
#define WT_FC_DDR_ADDR    0x000d48

#define IMAGES_DDR_ADDR   0x001754
#define LABELS_DDR_ADDR   0x001748
